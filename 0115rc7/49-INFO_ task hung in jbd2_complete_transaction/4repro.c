...
int main(void)
{
  ...
  *(uint32_t*)0x200000d8 = -1;
  ...
  res =
      syscall(__NR_io_uring_setup, /*entries=*/0x203c, /*params=*/0x200000c0ul);
  if (res != -1)
    r[0] = res;
  *(uint32_t*)0x20000c04 = 0xfffffffc;
  *(uint32_t*)0x20000c08 = 0x20;
  *(uint32_t*)0x20000c0c = 3;
  *(uint32_t*)0x20000c10 = 0x2f1;
  *(uint32_t*)0x20000c18 = r[0];
  memset((void*)0x20000c1c, 0, 12);
  syz_io_uring_setup(/*entries=*/0xec8, /*params=*/0x20000c00, /*ring_ptr=*/0,
                     /*sqes_ptr=*/0);
  syscall(__NR_madvise, /*addr=*/0x20000000ul, /*len=*/0x7ffffffffffffffful,
