...
int main(void)
{
  ...
  *(uint32_t*)0x20000144 = 0x9264;
  *(uint32_t*)0x20000148 = 0x48;
  *(uint32_t*)0x2000014c = 0x404;
  *(uint32_t*)0x20000150 = 0x3b5;
  *(uint32_t*)0x20000158 = -1;
  memset((void*)0x2000015c, 0, 12);
  syz_io_uring_setup(/*entries=*/0x10f, /*params=*/0x20000140, /*ring_ptr=*/0,
                     /*sqes_ptr=*/0);
