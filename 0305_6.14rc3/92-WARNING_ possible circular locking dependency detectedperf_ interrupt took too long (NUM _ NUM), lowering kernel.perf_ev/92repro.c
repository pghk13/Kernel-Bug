...
void execute_call(int call)
{
  ...
  case 0:
    ...
    break;
  case 1:
    syscall(__NR_setsockopt, /*fd=*/r[0], /*level=*/0, /*optname=*/0x29,
            /*optval=*/0ul, /*optlen=*/0ul);
    break;
  case 2:
    *(uint32_t*)0x20000200 = 4;
    *(uint32_t*)0x20000204 = 0x80;
    *(uint8_t*)0x20000208 = 0x38;
    *(uint8_t*)0x20000209 = 0xd;
    *(uint8_t*)0x2000020a = 0x80;
    *(uint8_t*)0x2000020b = 2;
    *(uint32_t*)0x2000020c = 0;
    *(uint64_t*)0x20000210 = 0x7ff;
    *(uint64_t*)0x20000218 = 0x8004;
    *(uint64_t*)0x20000220 = 0;
    STORE_BY_BITMASK(uint64_t, , 0x20000228, 1, 0, 1);
    STORE_BY_BITMASK(uint64_t, , 0x20000228, 1, 1, 1);
    STORE_BY_BITMASK(uint64_t, , 0x20000228, 1, 2, 1);
    STORE_BY_BITMASK(uint64_t, , 0x20000228, 1, 3, 1);
    ...
    STORE_BY_BITMASK(uint64_t, , 0x20000228, 1, 9, 1);
    ...
    STORE_BY_BITMASK(uint64_t, , 0x20000228, 1, 13, 1);
    ...
    STORE_BY_BITMASK(uint64_t, , 0x20000228, 1, 20, 1);
    STORE_BY_BITMASK(uint64_t, , 0x20000228, 1, 21, 1);
    STORE_BY_BITMASK(uint64_t, , 0x20000228, 1, 22, 1);
    STORE_BY_BITMASK(uint64_t, , 0x20000228, 1, 23, 1);
    ...
    STORE_BY_BITMASK(uint64_t, , 0x20000228, 1, 34, 1);
    ...
    *(uint32_t*)0x20000230 = 0xfffffffb;
    *(uint32_t*)0x20000234 = 1;
    *(uint64_t*)0x20000238 = 0x101;
    *(uint64_t*)0x20000240 = 0xae9a;
    *(uint64_t*)0x20000248 = 0x21;
    *(uint64_t*)0x20000250 = 8;
    *(uint32_t*)0x20000258 = 0x7a8;
    *(uint32_t*)0x2000025c = 4;
    *(uint64_t*)0x20000260 = 0x3df2218f;
    *(uint32_t*)0x20000268 = 0xd;
    *(uint16_t*)0x2000026c = 0x99af;
    *(uint16_t*)0x2000026e = 0;
    *(uint32_t*)0x20000270 = 0;
    *(uint32_t*)0x20000274 = 0;
    *(uint64_t*)0x20000278 = 6;
    syscall(__NR_perf_event_open, /*attr=*/0x20000200ul, /*pid=*/0, /*cpu=*/-1,
            /*group=*/-1, /*flags=*/0ul);
    break;
  case 3:
    syscall(__NR_prctl, /*option=*/0x20ul, 0, 0, 0, 0);
    break;
  }
}
int main(void)
