...
memcpy((void*)0x20000500, "\x15\x00\x00\x00\x65\xff\xff\x04\x80\x00\x00\x08\x00\x39\x50\x32\x30\x30\x30", 19);
...
memcpy((void*)0x20000700, "trans=fd,rfdno=", 15);
sprintf((char*)0x2000070f, "0x%016llx", (long long)r[0]);
memcpy((void*)0x20000721, ",wfdno=", 7);
sprintf((char*)0x20000728, "0x%016llx", (long long)r[2]);
	syscall(__NR_mount, /*src=*/0ul, /*dst=*/0x20000000ul, /*type=*/0x200004c0ul, /*flags=MS_POSIXACL|MS_NOATIME*/0x10400ul, /*opts=*/0x20000700ul);
memcpy((void*)0x20000140, "./file0\000", 8);
	syscall(__NR_chmod, /*file=*/0x20000140ul, /*mode=*/0ul);
memcpy((void*)0x20000140, "./file0\000", 8);
	res = syscall(__NR_open, /*file=*/0x20000140ul, /*flags=O_WRONLY*/1ul, /*mode=*/0ul);
	if (res != -1)
		r[3] = res;
memcpy((void*)0x20000280, "blkio.bfq.io_wait_time\000", 23);
	res = syscall(__NR_openat, /*fd=*/0xffffff9c, /*file=*/0x20000280ul, /*flags=*/0x275a, /*mode=*/0);
	if (res != -1)
		r[4] = res;
	syscall(__NR_ftruncate, /*fd=*/r[4], /*len=*/0x2000009ul);
	syscall(__NR_sendfile, /*fdout=*/r[3], /*fdin=*/r[4], /*off=*/0ul, /*count=*/0x7ffff000ul);
